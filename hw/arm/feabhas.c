...
static void feabhas_32f412_init(MachineState *machine,
  ...
  //   qdev_connect_gpio_out((DeviceState *)gpio[STM32_GPIOD_INDEX], 13,
  //                         backlight_enable);

  //   qemu_irq backlight_level;
  //   backlight_level = qdev_get_gpio_in_named(display_dev, "backlight_level",
  //   0); qdev_connect_gpio_out_named((DeviceState *)timer[2], // TIM3
