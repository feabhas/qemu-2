...
// void pebble_32f439_init(MachineState *machine, const PblBoardConfig
// *board_config); void pebble_32f7xx_init(MachineState *machine, const
// PblBoardConfig *board_config);
...
//                           const PblBoardConfig *board_config);
// void pebble_connect_uarts_stm32f7xx(Stm32F7xxUart *uart[],
//                                     const PblBoardConfig *board_config);
